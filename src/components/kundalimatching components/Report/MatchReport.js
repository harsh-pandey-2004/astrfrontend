...
const MatchReport = () => {
  ...
  const fetchKundli = async () => {
    try {
      const url = `https://api.vedicastroapi.com/v3-json/matching/ashtakoot?boy_dob=${details.boy.day}/${details.boy.month}/${details.boy.year}&boy_tob=${details.boy.hour}:${details.boy.minute}&boy_tz=5.5&boy_lat=${boyLat}&boy_lon=${boyLong}&girl_dob=${details.girl.day}/${details.girl.month}/${details.girl.year}&girl_tob=${details.girl.hour}:${details.girl.minute}&girl_tz=5.5&girl_lat=${girlLat}&girl_lon=${girlLong}&api_key=9e300788-82de-534a-ba13-47e11a18669f`;
