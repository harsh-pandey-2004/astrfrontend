...
const AstroCouncellorRegistrationForm = () => {
  const initialState = {
    name: "",
    mobile: "",
    password: "",
  ...
  return (
    <div className="bg-black shadow-md rounded  pb-8 mb-28 lg:w-1/2 w-[90%] mx-auto relative top-[6.8rem] lg:top-[6rem] md:w-3/4 sm:top-32 sm:w-4/5">
      ...
      >
        ...
        <button
          type="submit"
          className="bg-yellow-400 hover:box-shadow1  font-sans py-2 px-4 rounded-lg w-[95%] mx-auto"
          // onClick={() => navigate(`verify-phone/${phoneNumber}`)}
        >
          GET OTP <i className="fa fa-arrow-right"></i>
        </button>
        <div className="w-full flex justify-center my-1">
          <p className="text-center text-yellow-400 hover:text-yellow-300 hover:underline cursor-pointer" onClick={()=>navigate("/loginPandit")}>Already have Account ?</p>
        </div>
...
export default AstroCouncellorRegistrationForm;
