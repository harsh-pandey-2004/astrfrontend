...
const  PanditTestimonial= ({ showblur }) => {
  return (
    <div
      className={`mt-6 p-5 w-full sm:w-[75%] mx-auto relative top-20 lg:top-0 ${
        showblur
    ...
    >
      <div className="flex flex-col gap-3 items-center">
        ...
        <h1 className="text-4xl font-serif">
          Our <span className="text-orange-500">Pandits...</span>
        </h1>
      </div>
        ...
        <Marquee>
          <div className="flex flex-col items-center justify-center border-2 px-10 gap-5 py-10 border-b-4 border-b-orange-500 shadow-2xl">
            ...
            <div className="flex flex-col items-center gap-2">
              ...
              <p className="text-xl font-serif">Ashu</p>
            </div>
          </div>
...
export default PanditTestimonial;
