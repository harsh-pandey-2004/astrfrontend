...
const RegisterForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      let a = await axios.post("https://astrobackend.onrender.com/api/register", {
        ...response,
        mobile: phoneNumber,
        countrycode: countryCode,
      });
  ...
  return (
    <div className="bg-black shadow-md rounded pb-8   mb-16 lg:w-1/2 w-[90%] mx-auto relative top-[12.8rem] lg:top-[6rem] md:w-3/4 sm:top-32 sm:w-4/5">
      <form
        autoComplete="on"
