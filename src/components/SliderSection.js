...
const Carousel = () => {
  ...
  return (
    <div
      className={`w-full h-[100vh] main-Slider relative top-24 lg:top-0 flex flex-col min-h-fit items-center lg:h-[85vh] sm:h-[89vh] xl:h-[80vh]`}
    >
      ...
      <div className="grid grid-cols-2 relative top-16 sm:grid-cols-3 lg:grid-cols-6 w-[90%] sm:w-[90%] lg:w-[88%] lg:top-20 gap-4 xl:w-[80%]">
        <div className="flex flex-col items-center justify-center bg-white rounded-lg lg:px-5 lg:py-3 w-full min-w-36">
        ...
        <div className="flex flex-col items-center justify-center bg-white rounded-lg lg:px-5 lg:py-3 py-1 w-full min-w-36">
          <div className="W-10 h-10 rounded-full xl:w-12 xl:h-12">
            <img
        ...
        <div className="flex flex-col items-center justify-center bg-white rounded-lg lg:px-1 lg:py-3 w-full min-w-36">
          <div className="W-10 h-10 rounded-full xl:w-12 xl:h-12">
            <img
        ...
        <div className="flex flex-col items-center justify-center bg-white rounded-lg lg:px-5 lg:py-3 p-1 w-full min-w-36">
          <div className="W-10 h-10 rounded-full xl:w-12 xl:h-12">
            <img
