...
useEffect(() => {
  ...
  useEffect(()=>{
    const fetchReport=async()=>{
      try{
        const res=await fetch(`https://api.vedicastroapi.com/v3-json/extended-horoscope/rudraksh-suggestion?dob=${formData.day}/${formData.month}/${formData.year}&tob=${formData.hour}:${formData.minute}&lat=${userLat}&lon=${userLong}&tz=5.5&api_key=98d42535-b080-5dad-a6dc-5084c3f6d243&lang=en`);
