...
useEffect(()=>{
  const fetchYogas=async()=>{
    try{
       const res=await fetch("https://api.vedicastroapi.com/v3-json/extended-horoscope/yoga-list?dob=21/04/2021&tob=11:40&lat=11&lon=77&tz=5.5&api_key=290bddbe-4d06-5662-8aac-bfa5b725a565&lang=en");
