...
const PlanetHead = () => {
  return (
    <div className='md:flex xs:flex-col   px-4 md:px-12 bg-black pb-2  bg-parallaz bg-fixed bg-cover '>
      <div className='md:w-3/4 flex flex-col gap-6 pl-6'>
            ...
            <div className='flex flex-col gap-12 sm:flex-row items-center md:gap-40 text-white mb-32'>
