...
<div className='flex flex-col '>
   ...
   className='bg-yellow-100 focus:outline-none'/>
                    ...
                    <div className='flex flex-col  '>
                         <label htmlFor='gotra' className='text-gray-600'>Gotra</label>
                         <input id="gotra" type="text" className='bg-yellow-100 focus:outline-none' value="Kashyap" />
                    </div>
                    ...
                    <div className='flex flex-col '>
                        ...
                        <input id="gender" type="text" value="Male" className='bg-yellow-100 focus:outline-none'/>
                    </div>
                         </div>
                ...
                <div className=' md:flex xs:flex-col  justify-between mt-6 border-b border-black  pb-2'>
                    ...
                    <div >
                    <label htmlFor='skills' className='text-gray-600'>Experience</label>
                    ...
                    <div>
                       ...
                       <p>12+ Years</p>
                         ...
                         <div className='flex flex-col pl-12 '>
                            <label htmlFor='city' className='text-gray-600'>Live in(city)</label>
                            <input type="text" className='bg-yellow-100 focus:outline-none' value="Delhi"/>
                         </div>

                         <div className='flex flex-col '>
                         <label htmlFor='lang' className='text-gray-600'>Languages</label>
                         <input type="text" className='bg-yellow-100 focus:outline-none' value="Hindi,Tamil"/>
                         </div>
          ...
          >
            Add
                       ...
                       <div  className=' relative  w-1/3 '>
                               ...
                               <button className='text-sm  absolute right-0 top-1' onClick={()=>{setReadphone(false)}}> <FaRegEdit /></button>
                          ...
                          onChange={ChangeHandler} readOnly={readmail}/>
                           <button className='text-sm  absolute right-0 top-1' onClick={()=>{setReadmail(false)}}> <FaRegEdit /></button>
