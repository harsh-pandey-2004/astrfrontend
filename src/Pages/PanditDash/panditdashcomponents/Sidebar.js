    ...
    <div className='sidebar w-1/5    h-screen flex flex-col items-center overflow-y-auto '>
        ...
        <div className='flex flex-col items-center gap-2 border-b-2 border-black pt-6 pb-2 w-full'>
            <div className='relative  rounded-full '>
              ...
              <p className='font-semibold text-blue-400'>RamaKrishna</p>
        ...
        <div className='flex flex-col items-center gap-4 pt-4  text-center'>
                 ...
                 <div className='py-2 px-3 rounded-full border hover:bg-yellow-400 transition hover:cursor-pointer hover:text-white text-sm w-full bg-slate-100  '>  <Link to="/"> Edit Profile  </Link> </div>
            ...
            <div className='py-2 px-3 rounded-full border hover:bg-yellow-400 transition hover:cursor-pointer hover:text-white text-sm w-full bg-slate-100  '>  <Link to="/bookings">Bookings  </Link></div>
          

           
            <div className='py-2 px-3 rounded-full border hover:bg-yellow-400 transition hover:cursor-pointer hover:text-white text-sm w-full  bg-slate-100'> <Link to="/stats">Stats </Link></div>
           

         
            <div className='py-2 px-3 rounded-full border hover:bg-yellow-400 transition hover:cursor-pointer hover:text-white text-sm w-full  bg-slate-100 '>Support</div>
