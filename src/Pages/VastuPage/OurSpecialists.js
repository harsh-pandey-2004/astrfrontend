    ...
    <div className="text-left">
      ...
      <div className="mb-4">
        <h3 className="text-xl font-semibold text-gray-800 mb-2 flex items-center">
          <FaCertificate className="md:mr-2 text-yellow-500" /> Qualifications
        </h3>
        <ul className="list-disc md:pl-5 space-y-2">
          {specialist.qualifications.map((qual, index) => (
            ...
            >
              <FaCertificate className="md:mr-2 text-[#f6c300]" /> {qual}
            </li>
          ))}
        </ul>
      </div>
        ...
        <ul className="pl-5 space-y-2">
          {specialist.achievements.map((ach, index) => (
            <li
              ...
              className="text-[#f6c300] bg-black p-2 rounded-md shadow-sm flex items-center"
            >
              <FaTrophy className="mr-2 w-5 h-5" /> {ach}
            </li>
          ))}
        </ul>
      </div>
      ...
      <div className="flex gap-4 mt-4 items-center justify-center md:justify-end">
        <a
