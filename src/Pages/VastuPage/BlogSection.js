  ...
  return (
    <section className="bg-yellow-100 py-12 px-6 lg:px-12">
      <div className="max-w-7xl mx-auto text-center">
        <h2 className="text-4xl font-bold text-gray-800 mb-6" data-aos="fade-up">Congrats on Getting Your New Home!</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          <div className="bg-white p-6 shadow-xl rounded-lg" data-aos="fade-right">
          ...
          <div className="bg-white p-6 shadow-xl rounded-lg" data-aos="fade-left">
